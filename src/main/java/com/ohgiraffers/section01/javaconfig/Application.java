...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        Environment environment = new Environment(
                "dev"                                                 // 환경 정보 이름
                , new JdbcTransactionFactory()                         // 트랜젟션 매니저 종류 결정(JDBC or MANAGED)
        ...
        configuration.addMapper(Mapper.class);     //mapper 등록 , mapper = dao 랑 유사
         ...
         */
        SqlSessionFactory sqlSessionFactory = new SqlSessionFactoryBuilder().build(configuration);   // 빌더에 만들어라 콘피그션
        ...
        Mapper mapper = sqlSession.getMapper(Mapper.class); // mapper 는 인터페이스기 때문에 간접 구현
